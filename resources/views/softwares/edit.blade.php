        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="description" class="form-control" value="{{ $software->description }}"
                ...
                <div class="form-group">
                    <strong>URL:</strong>
                    <input type="text" name="url" class="form-control" placeholder="URL" value="{{ $software->url }}">
                </div>
            </div>
